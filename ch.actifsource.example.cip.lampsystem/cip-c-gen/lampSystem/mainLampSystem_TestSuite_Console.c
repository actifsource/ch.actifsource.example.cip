...
int runnerAnimation(FILE *fp)
{
  ...
  printf("[==========] Running 0 test from 1 test case.\n");
  printf("[----------] Global test environment set-up.\n");
  printf("[----------] 0 test from LampSystemTestSuite\n");
  ...
  printf("[----------] 0 test from LampSystemTestSuite (0 ms total)\n");
  printf("\n> SUMMARY: %i Test Case(s) Executed.\n",nSuceededTestCases+nFailedTestCases); 
  if (nFailedTestCases) {
  	printf("> WARNING: %i Test Case(s) Failed.\n",nFailedTestCases);
  }
  printf("[----------] Global test environment tear-down\n");
  printf("[==========] 0 test from 1 test case ran. (0 ms total)\n");
  return nFailedTestCases;
}
...
/* Actifsource ID=[bc0af8c6-407d-11e2-9941-ff65f3a86106,b5297e61-b785-11ea-9e22-1112d6355503,/pv0PcCXvbjSONsBPjAEFQfo4UM=] */
