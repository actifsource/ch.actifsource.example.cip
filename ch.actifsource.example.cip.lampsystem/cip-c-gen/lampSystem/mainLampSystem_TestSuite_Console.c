...
int testCase_TestLamp(int mainTestCase)
{
  ...
  sRecorded.actionMessage = eActionMessage_LampActions_Bright;
  if (!assertMessageAction(sRecorded,"TestEvent ButtonEvents.Push [ab573106-b786-11ea-9e22-1112d6355503]","[aee5ae98-b786-11ea-9e22-1112d6355503]", "TestLamp" ,0)) {return 0;}
  if (!assertMessageActionCount("TestEvent ButtonEvents.Push [ab573106-b786-11ea-9e22-1112d6355503]", "TestLamp")) {return 0;}
...
int runnerAnimation(FILE *fp)
{
  ...
  if (testCase_TestLamp(1)) {
	...
	printToFile(fp, "    <testcase name=\"TestLamp\" status=\"run\">\n");
	printToFile(fp, "        <failure><![CDATA[Failure testcase: a38033ee-b786-11ea-9e22-1112d6355503]]></failure>\n");
...
/* Actifsource ID=[bc0af8c6-407d-11e2-9941-ff65f3a86106,b5297e61-b785-11ea-9e22-1112d6355503,bfcvIcTnvMdHhIwgYSzDLMgNwpA=] */
