/*********************************************************************
  ...
  Filename: mainLampSystem_ETL_TestSuite_Console.cpp
...
#include "cipmachine/CIPM_mLampUnit.hpp"
...
namespace dec
{
	...
	typedef enum EActionMessage
	{
	  ...
	  eActionOutpulseBufferError,
	  eActionOutmsgBufferError,
	...
	const int checkedOutputMessage_TestLamp[eActionMessageCount] = {1, 1, 1, 1, 1};
	...
	int assertMessageAction(T_RecordedActionMessage sRecordedActionMessage, const char* const i_pcTestEventGuid, const char* const i_pcActionMessageGuid, const char* const i_testCaseName, int checkData)
	{
	  if (g_nExpectedActionMessageCount >= g_nRecordedActionMessageCount) 
	  {
	    if (g_eAnimationMode == eAnimationMode_Runner) {
	    	printf("d37d7711-fb29-11ee-88af-c1ff99c74ce0.asr: Failure\n");
	    	printf("TestCase: %s\n", i_testCaseName);
	    }
	 ...
	 */	
	class ActionInitiation :	 
		public lampunit::cipshell::INTF_ActionMessagePort
	{
	public:
		void f_C2_Bright(void);
		void f_C2_Dark(void);
	};


	/** Action Message implementation */
	void ActionInitiation::f_C2_Bright(void)
	{
	...
	void ActionInitiation::f_C2_Dark(void)
	{
	...
	lampunit::cipshell::INTF_mLampUnit* m_cipmachine;
	...
	int fINIT_Machine(void)
	{
		...
		m_cipmachine = new lampunit::cipmachine::CIPM_mLampUnit(13, 13, amp);
		return true;
	} // fINIT_Machine()
	...
	int testCase_TestLamp(int mainTestCase)
	{
	  ...
	  if (mainTestCase) 
	  {
	    printf(">>> TestCase TestLamp [d37d7715-fb29-11ee-88af-c1ff99c74ce0]\n");
	    s_nSystemTick = 0;
	    g_nRecordedActionMessageCount = 0;
	    g_nExpectedActionMessageCount = 0;
	    if (!fINIT_Machine()) 
	  ...
	  sRecorded.actionMessage = eActionMessage_LampActions_Bright;
	  if (!assertMessageAction(sRecorded,"TestEvent ButtonEvents.Push [d37d7714-fb29-11ee-88af-c1ff99c74ce0]","[d37d7712-fb29-11ee-88af-c1ff99c74ce0]","TestLamp" ,0)) {return 0;}
	  if (!assertMessageActionCount("TestEvent ButtonEvents.Push [d37d7714-fb29-11ee-88af-c1ff99c74ce0]", "TestLamp")) {return 0;}
	  
	  sendMessageEvent(eEventMessage_ButtonEvents_Release, 50, 50, &data);
	  if (!assertMessageActionCount("TestEvent ButtonEvents.Release [ad3f5b08-fb2b-11ee-88af-c1ff99c74ce0]", "TestLamp")) {return 0;}
	  
	  data.tick = 5;
	  sendMessageEvent(eEventMessage_Tick, 50, 50, &data);
	  sRecorded.actionMessage = eActionMessage_LampActions_Dark;
	  if (!assertMessageAction(sRecorded,"TestEvent TICK_[5] [b1221389-fb2b-11ee-88af-c1ff99c74ce0]","[b9fa549d-fb2b-11ee-88af-c1ff99c74ce0]","TestLamp" ,0)) {return 0;}
	  if (!assertMessageActionCount("TestEvent TICK_[5] [b1221389-fb2b-11ee-88af-c1ff99c74ce0]", "TestLamp")) {return 0;}
	...
	{
	  printf("TESTING: CipTestSuite LampSystemTestSuite_ETL [d37d7711-fb29-11ee-88af-c1ff99c74ce0]\n\n"); 
